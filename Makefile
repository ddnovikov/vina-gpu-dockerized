...
debug:./main/main.cpp
	gcc -o Vina-GPU $(BOOST_INC_PATH) $(VINA_GPU_INC_PATH) $(OPENCL_INC_PATH) ./main/main.cpp -g $(SRC) $(LIB1) $(LIB2) $(LIB3) $(LIB_PATH) $(MACRO) $(OPTION) --verbose -DBUILD_KERNEL_FROM_SOURCE 
clean:
	rm Vina-GPU
